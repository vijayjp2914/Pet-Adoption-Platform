...
const AdminLoginModal = ({ onClose, onAdminLoginSuccess }) => {
    ...
    return (
        <Modal title="Admin Login" onClose={onClose}>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <button type="submit" disabled={loading} className="bg-gradient-to-r from-red-500 to-orange-500 text-white font-bold py-3 rounded-lg disabled:opacity-50">
